            ...
            <table class="table table-dark table-striped table-hover align-middle">
                ...
                <tbody>
                    ...
                    foreach ($expenses as $expense) {
                        ...
                        echo '<td class="texto-tabla">'
                    ?>

                        <!-- Button trigger modal -->
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal<?php echo $expense->getId() ?>">
                            Actualizar
                        </button>
                        <div class="modal fade" id="myModal<?php echo $expense->getId() ?>">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?php echo constant('URL') ?>expenses/updateItem" method="post">

                                            <label for="title" class="form-label">Nota</label>
                                            <input type="text" class="form-control" name="title" id="title" value="<?php echo $expense->getTitle()?>" autocomplete="off" required placeholder="Nota">
                                            <br>
                                            <label for="category_id" class="form-label">Categoria</label>
                                            <select class="form-select form-select-m" name="category_id" id="category_id">
                                                <?php
                                                foreach ($categorias as $category) {
                                                    if ($category->getId() == $expense->getCategory_id()) {
                                            ...
                                            <input class="form-control" type="money" name="amount" id="amount" value="<?php echo $expense->getAmount()?>" autocomplete="off" required placeholder="Monto">
                                            <br>
                                            <label class="form-label" for="date">Fecha</label>
                                            <input class="form-control" type="date" name="date" id="date" value="<?php echo date('Y-m-d', strtotime($expense->getDate()))  ?>" autocomplete="off" required>
                                            <br>
                        ...
                        echo '<td>';
                        ?>
                        <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#miModal<?php echo $expense->getId() ?>">
                            Eliminar
                        </button>
                        <div class="modal fade" id="miModal<?php echo $expense->getId() ?>">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?php echo constant('URL') ?>expenses/deleteItem" method="post">
